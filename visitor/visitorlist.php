...
if (isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0) {
    $stmt = $conn->prepare("DELETE FROM tbl_visitor WHERE vid = ?");
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div align="right" style="margin-bottom:1%;">
                <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>visitor/addvisitor.php" data-original-title="<?php echo $_data['text_3']; ?>"><i class="fa fa-plus"></i></a>
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>visitor/addvisitor.php?id=<?php echo $row['vid']; ?>" data-original-title="<?php echo $_data['edit_text']; ?>"><i class="fa fa-pencil"></i></a>
                                        <a class="btn btn-danger" data-toggle="tooltip" onclick="deleteVisitor(<?php echo $row['vid']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text']; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php } 
                            $stmt->close(); ?>
