...
if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
	$sqlx = "DELETE FROM `tbl_add_fund` WHERE fund_id = ?";
...
// Thông báo thêm hoặc cập nhật quỹ
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;"> 
      <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>fund/add_fund.php" data-original-title="<?php echo $_data['add_new_fund_breadcam'];?>"><i class="fa fa-plus"></i></a> 
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        <?php
		$stmt = $conn->prepare("SELECT *, ow.o_name, ow.image, m.month_name, y.xyear as y_xyear 
                                FROM tbl_add_fund fu 
		...
		?>
            ...
            <td>
            <a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onclick="$('#nurse_view_<?php echo $row['fund_id']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>"><i class="fa fa-eye"></i></a> 
            <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL;?>fund/add_fund.php?id=<?php echo $row['fund_id']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a> 
            <a class="btn btn-danger" data-toggle="tooltip" onclick="deleteFund(<?php echo $row['fund_id']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                ...
                <div class="modal-content">
				  ...
				  <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-6"> 
                        <b><?php echo $_data['add_new_form_field_text_7'];?> :</b> <?php echo $currency_position == 'left' ? $global_currency . $row['total_amount'] : $row['total_amount'] . $global_currency; ?><br/>
...
function deleteFund(Id){
  	var iAnswer = confirm("Are you sure you want to delete this fund?");
	if(iAnswer){
