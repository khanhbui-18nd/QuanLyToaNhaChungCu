...
if (isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0) {
    $stmt = $conn->prepare("DELETE FROM `tbl_add_employee` WHERE eid = ?");
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>employee/addemployee.php" data-original-title="<?php echo $_data['add_new_employee_breadcam'];?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
            $stmt = $conn->prepare("SELECT *, mt.member_type FROM tbl_add_employee e INNER JOIN tbl_add_member_type mt ON mt.member_id = e.e_designation WHERE e.branch_id = ?");
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onClick="$('#nurse_view_<?php echo $row['eid']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>"><i class="fa fa-eye"></i></a>
                <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL;?>employee/addemployee.php?id=<?php echo $row['eid']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a>
                <a class="btn btn-danger" data-toggle="tooltip" onClick="deleteEmployee(<?php echo $row['eid']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-xs-12"> 
                            <b><?php echo $_data['add_new_form_field_text_1'];?> :</b> <?php echo $row['e_name']; ?><br/>
