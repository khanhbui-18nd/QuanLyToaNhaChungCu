  ...
  <div class="col-xs-12">
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        ...
        $result = $conn->query("SELECT *, ow.o_name, ow.image, m.month_name, y.xyear AS y_xyear 
        ...
        ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['o_name'], ENT_QUOTES, 'UTF-8'); ?></td>
                <td><?php echo htmlspecialchars($row['month_name'], ENT_QUOTES, 'UTF-8'); ?></td>
                <td><?php echo htmlspecialchars($row['y_xyear'], ENT_QUOTES, 'UTF-8'); ?></td>
                <td><?php echo htmlspecialchars($row['f_date'], ENT_QUOTES, 'UTF-8'); ?></td>
                <td><?php echo htmlspecialchars($row['total_amount'], ENT_QUOTES, 'UTF-8') . ' ' . CURRENCY; ?></td>
                <td><?php echo htmlspecialchars($row['purpose'], ENT_QUOTES, 'UTF-8'); ?></td>
                <td>
                    <a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onclick="$('#nurse_view_<?php echo $row['fund_id']; ?>').modal('show');" data-original-title="Details View">
                        <i class="fa fa-eye"></i>
                    </a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body model_view" align="center">&nbsp;
                                    ...
                                    <div class="model_title"><?php echo htmlspecialchars($row['o_name'], ENT_QUOTES, 'UTF-8'); ?></div>
                                </div>
                                <div class="modal-body">
                                    <h3 style="text-decoration:underline;"><?php echo $_data['details_information']; ?></h3>
                                    <div class="row">
                                        <div class="col-xs-6"> 
                                            <b><?php echo $_data['text_2']; ?> :</b> <?php echo htmlspecialchars($row['o_name'], ENT_QUOTES, 'UTF-8'); ?><br/>
                                            <b><?php echo $_data['text_3']; ?> :</b> <?php echo htmlspecialchars($row['month_name'], ENT_QUOTES, 'UTF-8'); ?><br/>
                                        </div>
                                        <div class="col-xs-6"> 
                                            <b><?php echo $_data['text_9']; ?> :</b> <?php echo htmlspecialchars($row['total_amount'], ENT_QUOTES, 'UTF-8') . ' ' . CURRENCY; ?><br/>
                                            <b><?php echo $_data['text_10']; ?> :</b> <?php echo htmlspecialchars($row['f_date'], ENT_QUOTES, 'UTF-8'); ?><br/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function deleteOwnerUtility(Id){
    var iAnswer = confirm("Are you sure you want to delete this Owner Utility?");
    if(iAnswer){
