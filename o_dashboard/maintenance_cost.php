<?php 
include('../config.php'); // Thêm dòng này
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        ...
        while($row = mysqli_fetch_assoc($result)){ ?>
            <tr>
            <td><?php echo htmlspecialchars($row['m_title']); ?></td>
            <td><?php echo htmlspecialchars($row['m_date']); ?></td>
            <td><?php echo htmlspecialchars($row['m_amount']).' '.CURRENCY; ?></td>
            <td><?php echo htmlspecialchars($row['m_details']); ?></td>
            <td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body model_view" align="center">&nbsp;
                    ...
                    <div class="model_title"><?php echo htmlspecialchars($row['m_title']); ?></div>
                  </div>
                  <div class="modal-body">
                    <h3 style="text-decoration:underline;"><?php echo $_data['details_information'];?></h3>
                    <div class="row">
                      <div class="col-xs-12"> 
                        <b><?php echo $_data['text_2'];?> :</b> <?php echo htmlspecialchars($row['m_title']); ?><br/>
                        <b><?php echo $_data['text_3'];?> :</b> <?php echo htmlspecialchars($row['m_date']); ?><br/>
                        <b><?php echo $_data['text_4'];?> :</b> <?php echo htmlspecialchars($row['m_amount']).' '.CURRENCY; ?><br/>
                        <b><?php echo $_data['text_5'];?> :</b> <?php echo htmlspecialchars($row['m_details']); ?><br/>
                      </div>
                    </div>
                  </div>
                </div>
