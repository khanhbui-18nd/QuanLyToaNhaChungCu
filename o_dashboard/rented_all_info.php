    ...
    <div align="center" style="margin:50px;">
        ...
        <div class="row">
            ...
            <?php
                ...
                $unit_no = mysqli_real_escape_string($conn, $_GET['uid']);
                $month_id = mysqli_real_escape_string($conn, $_GET['mid']);
                $year_id = mysqli_real_escape_string($conn, $_GET['yid']);
                
                $result = mysqli_query($conn, "
                    SELECT *, r.r_name, o.o_name, fl.floor_no, u.unit_no, m.month_name, r.r_unit_no 
                    FROM tbl_add_fair f 
                    ...
                    WHERE our.owner_id = '". (int)$_SESSION['objLogin']['ownid'] . "' 
                    AND f.unit_no = '$unit_no' 
                    AND f.month_id = '$month_id' 
                    AND f.xyear = '$year_id'
                ");
