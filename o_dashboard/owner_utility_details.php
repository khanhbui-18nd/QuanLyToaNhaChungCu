        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <table class="table sakotable table-bordered table-striped dt-responsive">
                    ...
                    <?php
                    // Sử dụng MySQLi
                    $result = mysqli_query($conn, "SELECT *, orl.owner_id, ow.o_name, ow.image, fl.floor_no AS fl_floor, u.unit_no AS u_unit, m.month_name 
                        FROM tbl_add_fair f 
                        INNER JOIN tbl_add_unit u ON u.uid = f.unit_no 
                        INNER JOIN tbl_add_owner_unit_relation orl ON orl.unit_id = u.uid 
                        INNER JOIN tbl_add_owner ow ON ow.ownid = orl.owner_id 
                        INNER JOIN tbl_add_floor fl ON fl.fid = f.floor_no 
                        INNER JOIN tbl_add_month_setup m ON m.m_id = f.month_id 
                        WHERE orl.owner_id = '" . (int)$_SESSION['objLogin']['ownid'] . "' AND f.type = 'Owner' 
