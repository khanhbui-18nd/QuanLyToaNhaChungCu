                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
                                ...
                                $unit_id = mysqli_real_escape_string($conn, $_GET['uid']);
                                $query = "SELECT *, r.r_name, o.o_name, fl.floor_no, u.unit_no, m.month_name, r.r_unit_no 
                                          FROM tbl_add_fair f 
                                          ...
                                          WHERE our.owner_id = '" . (int)$_SESSION['objLogin']['ownid'] . "' AND f.unit_no = '$unit_id'";
