...
<div class="row">
  <div class="col-xs-12">
    <div align="right" style="margin-bottom:1%;">
        <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>o_dashboard.php" data-original-title="Dashboard"><i class="fa fa-dashboard"></i></a>
    </div>
    <div class="box box-info">
      <!-- /.box-header -->
      <div class="box-body">
        <?php
        $query = "SELECT * FROM tbl_add_owner WHERE ownid = '" . (int)$_SESSION['objLogin']['ownid'] . "' ORDER BY ownid DESC";
        ...
        ?>
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-xs-12"> 
                  <b>Name :</b> <?php echo $row['o_name']; ?><br/>
