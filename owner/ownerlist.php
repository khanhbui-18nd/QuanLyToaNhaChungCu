...
if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
	$sqlx= "DELETE FROM `tbl_add_owner` WHERE ownid = ?";
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
            $result = $conn->query("SELECT * FROM tbl_add_owner WHERE branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " ORDER BY ownid DESC");
            ...
            <tr>
              ...
              <td><?php
				 $i=1;
				 $result_sp = $conn->query("SELECT u.unit_no FROM tbl_add_owner_unit_relation owr INNER JOIN tbl_add_unit u ON owr.unit_id = u.uid WHERE owr.owner_id = '". $row['ownid'] . "' ORDER BY u.unit_no ASC");
