        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
            <?php
            $result = mysqli_query($conn, "SELECT *, bt.bill_type AS bt_type, m.month_name, y.xyear, bt.bt_id FROM tbl_add_bill b 
                ...
                WHERE b.bill_month='" . mysqli_real_escape_string($conn, $_GET['mid']) . "' 
