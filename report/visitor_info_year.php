                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT *, fl.floor_no AS fl_floor, u.unit_no, m.month_name 
                                              FROM tbl_visitor v 
                                              ...
                                              WHERE v.xyear = '" . mysqli_real_escape_string($conn, $_GET['yid']) . "' 
                                              AND v.branch_id = '" . (int)$_SESSION['objLogin']['branch_id'] . "'";
