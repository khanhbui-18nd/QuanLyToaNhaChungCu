      ...
      <div class="col-xs-12">
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            $result = mysqli_query($conn, "SELECT *, m.month_name FROM tbl_add_complain c INNER JOIN tbl_add_month_setup m ON m.m_id = c.c_month WHERE c.c_date='$vid' AND c.c_month='$mid' AND c.branch_id='$branch_id'");
