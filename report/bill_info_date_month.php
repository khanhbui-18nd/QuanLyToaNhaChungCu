                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($conn, "SELECT *, bt.bill_type as bt_type, m.month_name, y.xyear, bt.bt_id 
                                        FROM tbl_add_bill b 
                                        ...
                                        WHERE b.bill_date='" . mysqli_real_escape_string($conn, $_GET['vid']) . "' 
                                        AND b.bill_month='" . mysqli_real_escape_string($conn, $_GET['mid']) . "' 
                                        AND b.branch_id = '" . (int)$_SESSION['objLogin']['branch_id'] . "'");
