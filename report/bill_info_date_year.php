      ...
      <div class="col-xs-12">
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            $yid = $conn->real_escape_string($_GET['yid']);
            $branch_id = (int)$_SESSION['objLogin']['branch_id'];

            $result = $conn->query("SELECT *, bt.bill_type as bt_type, m.month_name, y.xyear, bt.bt_id 
                FROM tbl_add_bill b 
                ...
                WHERE b.bill_date='$vid' AND b.bill_year='$yid' AND b.branch_id='$branch_id'");
