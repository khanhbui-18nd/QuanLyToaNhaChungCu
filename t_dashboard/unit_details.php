...
include(ROOT_PATH.'language/'.'English'.'/lang_rented_unit_details.php');
  ...
  <div class="row">
    <div class="col-xs-12">
      <div align="right" style="margin-bottom:1%;">
        <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>t_dashboard.php" data-original-title="<?php echo $_data['dashboard']; ?>"><i class="fa fa-dashboard"></i></a>
      </div>
      <div class="box box-info">
        <!-- /.box-header -->
        <div class="box-body">
          <?php
          // Sử dụng MySQLi để thực hiện truy vấn
          $result = $conn->query("SELECT f.floor_no, u.unit_no, u.uid, r.r_name, r.r_email, r.r_contact, r.r_address, r.r_nid, r.r_floor_no, r.r_unit_no, r.r_advance, r.r_rent_pm, r.r_date, r.image AS r_image 
                                  FROM tbl_add_unit u 
                                  INNER JOIN tbl_add_floor f ON f.fid = u.floor_no 
                                  INNER JOIN tbl_add_rent r ON r.r_unit_no = u.uid 
                                  WHERE r.rid = '". (int)$_SESSION['objLogin']['rid'] . "' 
                                  ORDER BY u.uid DESC");
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-xs-6"> 
                  <b><?php echo $_data['text_5']; ?> :</b> <?php echo $row['r_name']; ?><br/>
                ...
                <div class="col-xs-6"> 
                  <b><?php echo $_data['text_9']; ?> :</b> <?php echo $row['floor_no']; ?><br/>
          ...
          // $conn->close(); // Nếu bạn muốn đóng kết nối tại đây, nếu không sẽ đóng ở nơi khác
          ?>
        </div>
        <!-- /.box-body -->
      </div>
