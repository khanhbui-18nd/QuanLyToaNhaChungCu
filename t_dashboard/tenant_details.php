...
include(ROOT_PATH.'language/'.'English'.'/lang_rented_tenant_details.php');
...
<div class="row">
  <div class="col-xs-12">
    <div align="right" style="margin-bottom:1%;">
      <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>t_dashboard.php" data-original-title="<?php echo $_data['text_19'];?>"><i class="fa fa-dashboard"></i></a>
    </div>
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        	<?php
				$result = $conn->query("SELECT *, fl.floor_no as fl_floor, u.unit_no as u_unit, r.r_name, m.month_name 
                                        FROM tbl_add_fair f 
                                        ...
                                        WHERE f.unit_no = '". (int)$_SESSION['objLogin']['r_unit_no'] . "' 
