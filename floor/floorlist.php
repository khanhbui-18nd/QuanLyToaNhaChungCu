...
if (isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0) {
    $stmt = $conn->prepare("DELETE FROM `tbl_add_floor` WHERE fid = ?");
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;">
      <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>floor/addfloor.php" data-original-title="<?php echo $_data['add_floor'];?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
        <?php
            $stmt = $conn->prepare("SELECT * FROM tbl_add_floor WHERE branch_id = ? ORDER BY fid DESC");
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>floor/addfloor.php?id=<?php echo $row['fid']; ?>" data-original-title="<?php echo $_data['edit_text'];?>"><i class="fa fa-pencil"></i></a>
                <a class="btn btn-danger" data-toggle="tooltip" onclick="deleteFloor(<?php echo $row['fid']; ?>);" href="javascript:;" data-original-title="<?php echo $_data['delete_text'];?>"><i class="fa fa-trash-o"></i></a>
