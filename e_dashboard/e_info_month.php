...
// Lấy mã ngôn ngữ từ cơ sở dữ liệu
...
<section class="content">
                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 style="text-decoration:underline;font-weight:bold;color:orange"
                                class="box-title"><?php echo $_data['text_1']; ?> </h3>
                        </div>
                        <div class="box-body">
                            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
                                ...
                                <tbody>
                                <?php
                                $emp_id = (int)$_SESSION['objLogin']['eid'];
                                $mid = $_GET['mid'];
                                $result = mysqli_query($conn, "SELECT *, m.month_name FROM tbl_add_employee_salary_setup es INNER JOIN tbl_add_month_setup m ON m.m_id = es.month_id WHERE es.emp_name = '$emp_id' AND es.month_id='$mid' ORDER BY es.emp_id DESC");
    ...
    <!-- /.row -->
    <div align="center">
        <a class="btn btn-primary btn_save" onClick="javascript:printContent('printable','Salary Report');" href="javascript:void(0);"><?php echo $_data['text_6']; ?></a>
    </div>
</section>
</body>
</html>
