    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
                $result = mysqli_query($conn, "SELECT *, f.floor_no AS ffloor, u.unit_no 
                                                FROM tbl_add_rent r 
            ...
            <tr>
              ...
              <td><?php echo ($row['r_status'] == '1') ? $_data['active'] : $_data['expired']; ?></td>
              <td>
                <a class="btn btn-success" data-toggle="tooltip" href="javascript:;" onclick="$('#nurse_view_<?php echo $row['rid']; ?>').modal('show');" data-original-title="<?php echo $_data['view_text'];?>">
                  <i class="fa fa-eye"></i>
                </a>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-6"> 
                            ...
                            <?php echo ($row['r_status'] == '1') ? $_data['active'] : $_data['expired']; ?>
                          </div>
                        </div>
                      </div>
                    </div>
